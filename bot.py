...
def handle_get_tempmail(message):
    ...
    kb.add(types.KeyboardButton("TEMPMAIL PLUS"))
    kb.add(types.KeyboardButton("🏠 Home"))
    bot.send_message(
        message.chat.id,
        "📧 <b>Tempmails</b>\n\n"
        "<b>CLICK A TEMPMAIL PLUS BUTTON 👇👇</b>",
        parse_mode="HTML",
        reply_markup=kb
    )

@bot.message_handler(func=lambda msg: msg.text == "TEMPMAIL PLUS")
def handle_tempmail_plus(message):
    kb = types.ReplyKeyboardMarkup(resize_keyboard=True, row_width=2)
    kb.row(types.KeyboardButton("mailto.plus"), types.KeyboardButton("fexpost.com"))
    kb.row(types.KeyboardButton("fexbox.org"), types.KeyboardButton("chitthi.in"))
...
@bot.message_handler(func=lambda msg: msg.text in ["mailto.plus", "fexpost.com", "fexbox.org", "chitthi.in"])
...
def handle_withdraw(message):
    ...
    bot.send_message(
        ...
        "💸 <b>উইথড্র</b>\n\n"
        "<b>────────────────────</b>\n"
        "<b>💳 পেমেন্ট মেথড: বিকাশ</b>\n"
        "<b>📌 সর্বনিম্ন উইথড্র: ৳৫০</b>\n\n"
        "<b>উইথড্র করতে নিচের বাটনে ক্লিক করুন।</b>\n"
        "<b>────────────────────</b>",
        parse_mode="HTML",
        reply_markup=kb
    )
